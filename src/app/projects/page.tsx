...
export default function Projects() {
  return (
    <SimpleLayout
      ...
      intro="I&apos;ve worked on tons of enterprise-level proejcts over the years but these are public-facing projects that I&apos;m most proud of. When the code is available, please do take a look and contribute!"
    >
      <ul
        role="list"

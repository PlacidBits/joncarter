...
import logoBelleTire from '@/images/logos/belle-tire.svg'
  ...
  return (
    <li className="flex gap-4">
      <div className="relative mt-1 flex h-10 w-10 flex-none items-center justify-center rounded-full shadow-md shadow-zinc-800/5 ring-1 ring-zinc-900/5 dark:border dark:border-zinc-700/50 dark:bg-zinc-800 dark:ring-0">
        {role.logo && <Image src={role.logo} alt="" className="h-7 w-7" unoptimized />}
        {!role.logo && <BriefcaseIcon className="h-7 w-7" />}
      </div>
...
function Resume() {
  let resume: Array<Role> = [
    ...
    {
      company: 'Rocket Mortgage (formerly Quicken Loans)',
      title: 'Senior Software Engineer',
      logo: logoRocketMortgage,
      start: '2013',
      end: '2019',
    },
    {
      company: 'XPO Logistics (formerly Landstar Supply Chain Solutions)',
    ...
    {
      company: 'National Outsourcing Solutions',
